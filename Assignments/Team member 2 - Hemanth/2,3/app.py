...
COS_API_KEY_ID = "m_bJnZXvv5gv-3diAvNTDplEcbN9zZJof9heQjQB1HYr"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:cloud-object-storage:global:a/50a97a2b3f364c72a03f8d656f8a3db8:b35c530d-7485-4341-858c-e5ae6b4c6190::"
...
@app.route('/')
def index():
    file1 = get_bucket_contents('bucket-gowtham')
